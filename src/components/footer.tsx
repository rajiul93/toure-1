      ...
      <div className="relative mx-auto max-w-7xl px-4 py-12 sm:py-14">
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-4">
            ...
            >
              <span className="text-lg font-bold tracking-tight text-white">{SITE.brand.name}</span>
              <span className="font-script text-2xl leading-none text-secondary">{SITE.brand.script}</span>
            </Link>
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-zinc-300">
              {LOUVRE_TOUR.shortDescription} {SITE.footerDescription}
            </p>
            ...
            <div className="mt-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-sm backdrop-blur-sm">
              ...
              <span className="font-bold tabular-nums">{LOUVRE_TOUR.rating}</span>
              <span className="text-zinc-400">·</span>
              <span className="text-zinc-300">{LOUVRE_TOUR.reviewCountLabel} reviews</span>
            </div>
          </div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3 text-sm text-zinc-300">
                <li className="flex gap-2.5">
                  ...
                  <span>{LOUVRE_TOUR.meetingPoint}</span>
                </li>
                <li>
                  <span className="font-medium text-white">Duration:</span>{' '}
                  {LOUVRE_TOUR.durationLabel}
                </li>
                <li>
                  <span className="font-medium text-white">From:</span> {LOUVRE_TOUR.priceLabel}{' '}
                  per person
                </li>
              </ul>
            </div>
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-white/10 pt-6 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-zinc-500">
            © {year} {LOUVRE_TOUR.brand}. All rights reserved.
          </p>
